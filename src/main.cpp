...
uint256 hashGenesisBlock("0x000009d31aad2453b78f8a69a0d3353c3c92382768bddccb3fd66cc087549cbf");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // AsiaBizCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "AsiaBizCoin Signed Message:\n";
...
{
    // AsiaBizCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	int64 nHalvingRate = 1800000000;
	int64 _nHeight = nHeight;
    nSubsidy >>= (_nHeight / nHalvingRate);
...
{
    // AsiaBizCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "AsiaBizCoin Genesis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xa146d0c28882731f82016c5d29e0b027dafe119872b7b0d4e66ac8435590dde7"));
...
unsigned char pchMessageStart[4] = { 0xf5, 0xc1, 0xb1, 0xdd }; // AsiaBizCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AsiaBizCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AsiaBizCoinMiner : ProcessBlock, block not accepted");
    }
